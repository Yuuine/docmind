...
public enum ErrorCode {
    ...
    DOCUMENT_INVALID_STATE(400, "DOCUMENT_INVALID_STATE", "文档状态不允许该操作"),
    CHAT_SESSION_NOT_FOUND(404, "CHAT_SESSION_NOT_FOUND", "会话不存在"),
    MODEL_NOT_FOUND(404, "MODEL_NOT_FOUND", "模型不存在"),
    ...
    EMAIL_ALREADY_EXISTS(409, "EMAIL_ALREADY_EXISTS", "邮箱已被使用"),
